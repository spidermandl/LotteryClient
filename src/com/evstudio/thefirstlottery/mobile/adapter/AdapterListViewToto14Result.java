 ...
 */
public class AdapterListViewToto14Result extends BaseAdapter {
    ...
    public AdapterListViewToto14Result(Context ctx, ArrayList<FootballGameInfo> list, Handler handler) {
        context = ctx;
        arrayList = list;
