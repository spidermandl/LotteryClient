 ...
 */
public class ActivityDltMultiple extends SherlockActivity {
    private ActionBar actionBar;
    private TextView[] redTv = new TextView[35];
    private TextView[] blueTv = new TextView[12];
    private TextView[] redDanTv = new TextView[35];
    private TextView[] blueDanTv = new TextView[12];
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_dlt_multiple);
//        setContentView(R.layout.layout_dlt);
        ...
        bbSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (listBlue.size() < 2 || listRed.size() < 5) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ActivityDltMultiple.this);
                    builder.setTitle("提示");
                ...
                int finalnumber = 1;
                for (int itmp = listRed.size(); itmp > 5; itmp--) {
                    finalnumber *= itmp;
                }
                combination = finalnumber;
                finalnumber = 1;
                for (int itmp = listBlue.size(); itmp > 2; itmp--) {
                    finalnumber *= itmp;
                }
                combination *= finalnumber;

                if (cash < 2 * Integer.parseInt(etBeishu.getText().toString()) * combination) {
                    AlertDialog alertDialog = new AlertDialog.Builder(ActivityDltMultiple.this).setTitle("提示")
                ...
                new AlertDialog.Builder(ActivityDltMultiple.this)
                        .setTitle("确认您的投注")
                        ...
                        .setPositiveButton("是", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                progressDialog = new ProgressDialog(ActivityDltMultiple.this);
                                ...
                                HttpRestClient.post("mobile/doBet", requestParams, new JsonHttpResponseHandler() {
                                    ...
                                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                                        ...
                                        MyToast.instance.showToast(ActivityDltMultiple.this,
                                                ActivityDltMultiple.this.getLayoutInflater(), "投注成功，感谢您的投注！");
        ...
        redDanTv[0] = (TextView) findViewById(R.id.tvBetItemDan1);
        redDanTv[1] = (TextView) findViewById(R.id.tvBetItemDan2);
        redDanTv[2] = (TextView) findViewById(R.id.tvBetItemDan3);
        redDanTv[3] = (TextView) findViewById(R.id.tvBetItemDan4);
        redDanTv[4] = (TextView) findViewById(R.id.tvBetItemDan5);
        redDanTv[5] = (TextView) findViewById(R.id.tvBetItemDan6);
        redDanTv[6] = (TextView) findViewById(R.id.tvBetItemDan7);
        redDanTv[7] = (TextView) findViewById(R.id.tvBetItemDan8);
        redDanTv[8] = (TextView) findViewById(R.id.tvBetItemDan9);
        redDanTv[9] = (TextView) findViewById(R.id.tvBetItemDan10);
        redDanTv[10] = (TextView) findViewById(R.id.tvBetItemDan11);
        redDanTv[11] = (TextView) findViewById(R.id.tvBetItemDan12);
        redDanTv[12] = (TextView) findViewById(R.id.tvBetItemDan13);
        redDanTv[13] = (TextView) findViewById(R.id.tvBetItemDan14);
        redDanTv[14] = (TextView) findViewById(R.id.tvBetItemDan15);
        redDanTv[15] = (TextView) findViewById(R.id.tvBetItemDan16);
        redDanTv[16] = (TextView) findViewById(R.id.tvBetItemDan17);
        redDanTv[17] = (TextView) findViewById(R.id.tvBetItemDan18);
        redDanTv[18] = (TextView) findViewById(R.id.tvBetItemDan19);
        redDanTv[19] = (TextView) findViewById(R.id.tvBetItemDan20);
        redDanTv[20] = (TextView) findViewById(R.id.tvBetItemDan21);
        redDanTv[21] = (TextView) findViewById(R.id.tvBetItemDan22);
        redDanTv[22] = (TextView) findViewById(R.id.tvBetItemDan23);
        redDanTv[23] = (TextView) findViewById(R.id.tvBetItemDan24);
        redDanTv[24] = (TextView) findViewById(R.id.tvBetItemDan25);
        redDanTv[25] = (TextView) findViewById(R.id.tvBetItemDan26);
        redDanTv[26] = (TextView) findViewById(R.id.tvBetItemDan27);
        redDanTv[27] = (TextView) findViewById(R.id.tvBetItemDan28);
        redDanTv[28] = (TextView) findViewById(R.id.tvBetItemDan29);
        redDanTv[29] = (TextView) findViewById(R.id.tvBetItemDan30);
        redDanTv[30] = (TextView) findViewById(R.id.tvBetItemDan31);
        redDanTv[31] = (TextView) findViewById(R.id.tvBetItemDan32);
        redDanTv[32] = (TextView) findViewById(R.id.tvBetItemDan33);
        redDanTv[33] = (TextView) findViewById(R.id.tvBetItemDan34);
        redDanTv[34] = (TextView) findViewById(R.id.tvBetItemDan35);

        blueDanTv[0] = (TextView) findViewById(R.id.tvBetItemDanB1);
        blueDanTv[1] = (TextView) findViewById(R.id.tvBetItemDanB2);
        blueDanTv[2] = (TextView) findViewById(R.id.tvBetItemDanB3);
        blueDanTv[3] = (TextView) findViewById(R.id.tvBetItemDanB4);
        blueDanTv[4] = (TextView) findViewById(R.id.tvBetItemDanB5);
        blueDanTv[5] = (TextView) findViewById(R.id.tvBetItemDanB6);
        blueDanTv[6] = (TextView) findViewById(R.id.tvBetItemDanB7);
        blueDanTv[7] = (TextView) findViewById(R.id.tvBetItemDanB8);
        blueDanTv[8] = (TextView) findViewById(R.id.tvBetItemDanB9);
        blueDanTv[9] = (TextView) findViewById(R.id.tvBetItemDanB10);
        blueDanTv[10] = (TextView) findViewById(R.id.tvBetItemDanB11);
        blueDanTv[11] = (TextView) findViewById(R.id.tvBetItemDanB12);

        for (int i = 0; i < 35; i++) {
            redTv[i].setOnClickListener(tvClick);
            redDanTv[i].setOnClickListener(tvClick);
        }

        for (int i = 0; i < 12; i++) {
            blueTv[i].setOnClickListener(tvClick);
            blueDanTv[i].setOnClickListener(tvClick);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                return true;
            case 0:
                assistTool.gotoActivity(DltActivity.class, true, null);
                return true;
            default:
                break;
        }
