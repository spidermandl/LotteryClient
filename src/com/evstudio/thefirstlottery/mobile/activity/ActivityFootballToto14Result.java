 ...
 */
public class ActivityFootballToto14Result extends SherlockActivity {
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!assistTool.getPreferenceBoolean("isLogon")) {
                    MyToast.instance.showToast(ActivityFootballToto14Result.this,
                            LayoutInflater.from(ActivityFootballToto14Result.this), "您尚未登录，请先登录！");
                ...
                if (cash < 2 * Integer.parseInt(String.valueOf(etBeishu.getText())) * ticketCount) {
                    AlertDialog alertDialog = new AlertDialog.Builder(ActivityFootballToto14Result.this).setTitle("提示")
                ...
                progressDialog = new ProgressDialog(ActivityFootballToto14Result.this);
                ...
                requestParams.put("periods", sellNumber);//足球胜负平14场
                ...
                HttpRestClient.post("mobile/doBet", requestParams, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        MyToast.instance.showToast(ActivityFootballToto14Result.this,
                                LayoutInflater.from(ActivityFootballToto14Result.this), "投注成功，感谢您的投注！");

                        EventBus.getDefault().post("betSuccess");

                        super.onSuccess(statusCode, headers, response);

                        ActivityFootballToto14Result.this.finish();
                    }
