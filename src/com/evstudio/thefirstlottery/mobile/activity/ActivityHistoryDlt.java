 ...
 */
public class ActivityHistoryDlt extends SherlockActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_activity_history_dlt);
        ...
        mActionBar.setTitle("购票历史（大乐透）");
        tvTip = (TextView)findViewById(R.id.tvHistoryDltTip);
