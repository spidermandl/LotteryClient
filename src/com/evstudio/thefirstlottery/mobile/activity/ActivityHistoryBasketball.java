 ...
 */
public class ActivityHistoryBasketball extends SherlockActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_activity_history_basketball);
        mActionBar = getSupportActionBar();

        tvTip = (TextView)findViewById(R.id.tvHistoryBasketballTip);

        mAssistTools = new AssistTool(this);

        mActionBar.setDisplayHomeAsUpEnabled(true);
        mActionBar.setTitle("购票历史（竞彩篮球）");
