...
import com.evstudio.thefirstlottery.mobile.adapter.AdapterListViewToto14;
 ...
 */
public class ActivityFootballToto14 extends SherlockActivity {
    ...
    private AdapterListViewToto14 adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvBuyTip.setText("至少选择14场比赛");
        adapter = new AdapterListViewToto14(this, arrayList, null);
    ...
    public void onEventMainThread(String json) {// 接收事件内容地方（参数类型可以自己根据实际情况定义）
        if ("totoSelected".equals(json)) {
            if (null != adapter) {
                this.tvBuyTip.setText("已选中" + adapter.selectedItems.size() + "场比赛,至少选择14场比赛");
            }
        }
    }
    ...
    private void showDialog(Context context) {
        ...
        builder.setTitle("提示");
        builder.setMessage("至少需要选择14场比赛！");
    ...
    Button.OnClickListener submitClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (adapter.selectedItems.size() < 9) {
                showDialog(ActivityFootballToto14.this);
                return;
            }
            ...
            intent.setClass(ActivityFootballToto14.this, ActivityFootballToto14Result.class);
            ActivityFootballToto14.this.startActivity(intent);
        }
    };
