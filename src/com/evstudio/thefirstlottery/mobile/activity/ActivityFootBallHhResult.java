...
import com.evstudio.thefirstlottery.mobile.adapter.AdapterListViewHhResult;
 ...
 */
public class ActivityFootBallHhResult extends SherlockActivity {
    private ActionBar actionBar;

    private ListView listView;
    private AdapterListViewHhResult adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //获得Intent中的Extra
        arrayList = (ArrayList<FootballInfoMix>) intent.getSerializableExtra("games");

        adapter = new AdapterListViewHhResult(this, arrayList, null);
        listView.setAdapter(adapter);

        listPlay.add(0);

        for (int i = 0; i < arrayList.size(); i++) {
            FootballInfoMix ginfo = (FootballInfoMix) arrayList.get(i);
        ...
        btnXz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(ActivityFootBallHhResult.this).setCancelable(true)
                        .setTitle("选择玩法")
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialoginterface, int i) {
                                        ...
                                        for (int k = 0; k < arrayList.size(); k++) {
                                            FootballInfoMix ginfo = arrayList.get(k);
        ...
        btnQd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!assistTool.getPreferenceBoolean("isLogon")) {
                    MyToast.instance.showToast(ActivityFootBallHhResult.this,
                            LayoutInflater.from(ActivityFootBallHhResult.this), "您尚未登录，请先登录！");
                    assistTool.gotoActivity(LoginActivity.class, false);
                    return;
                }

                if (null != listPlay && listPlay.size() == 0) {
                    AlertDialog alertDialog = new AlertDialog.Builder(ActivityFootBallHhResult.this).setTitle("提示")
                            .setMessage("请先选择玩法！")
                            .create();
                    alertDialog.show();
                    return;
                ...
                progressDialog = new ProgressDialog(ActivityFootBallHhResult.this);
                ...
                HttpRestClient.post("mobile/doBet", requestParams, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        MyToast.instance.showToast(ActivityFootBallHhResult.this,
                                LayoutInflater.from(ActivityFootBallHhResult.this), "投注成功，感谢您的投注！");

                        EventBus.getDefault().post("betSuccess");

                        super.onSuccess(statusCode, headers, response);

                        ActivityFootBallHhResult.this.finish();
                    }
